#!/usr/bin/python3
""" this class for Check Filestorage class """
import unittest
from os import path
...
class test_storage(unittest.TestCase):
    ...
    def test_no_objs(self):
        """ for check empty class  """
        self.assertEqual(storage.all(), {})

    def test_all(self):
        """ for check  all function """
        storage = FileStorage()
        obj = storage.all()
    ...
    def test_new_empty(self):
        """ for check new method """
        with self.assertRaises(TypeError):
            storage.new()

    def test_new_classes(self):
        """ for check  new method is valid """
